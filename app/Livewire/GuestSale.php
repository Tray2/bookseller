...
class GuestSale extends Component implements HasForms, HasTable, HasInfolists
{
    ...
    {
        return $table
            ->query(Book::query()->where('discounted_price', '!=', null))
            ->columns([
    ...
    {
        return view('livewire.guest-sale');
    }
}
